...
const numero1 = 20; // 'numero1' es una variable que almacena un número.
const numero2 = "20"; // 'numero2' es una variable que almacena una cadena de texto que representa un número.
